...
@Autonomous(name = "RightAutoBlue")
@SuppressWarnings("InnerClassMayBeStatic")
public class RightAutoBlue extends LinearOpMode {

    @Override
    public void runOpMode() throws InterruptedException {
        Pose2d initialPose = new Pose2d(-13.4, 62.7, Math.toRadians(270));
        ...
        Actions.runBlocking(
                drive.actionBuilder(initialPose)
                        ...
                        .splineToConstantHeading(new Vector2d(-48.7,5.4),270)
                        .strafeToConstantHeading(new Vector2d(-60, 5.4))
                        .strafeTo(new Vector2d(-65,58))
                        .lineToYSplineHeading(35,Math.toRadians(90))
                        .strafeToConstantHeading(new Vector2d(-65,34.5))
                        .stopAndAdd(new ArmPivot(-72, armRaise, 1, false))
                        .waitSeconds(2.5)
                        ...
                        .strafeToSplineHeading(new Vector2d(-10, 42.25),Math.toRadians(270))
                        .waitSeconds(.5)
                        .stopAndAdd(new ArmPivot(-82, armRaise, 1, false))
                        .waitSeconds(2)
