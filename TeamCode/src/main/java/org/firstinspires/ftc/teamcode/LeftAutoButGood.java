...
@Autonomous(name = "LeftAutoButGood")
@SuppressWarnings("InnerClassMayBeStatic")
public class LeftAutoButGood extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        PIDF_tuning PIDF = new PIDF_tuning();
        ...
        Actions.runBlocking(
                drive.actionBuilder(initialPose)
                        ...
                        .strafeToSplineHeading(new Vector2d(-65, -60), Math.toRadians(225))
                        ...
                        .turnTo(Math.toRadians(90))
                        .stopAndAdd(new LinearSlide(0, linearSlide, 1, false))
                        .strafeToSplineHeading(new Vector2d(-58, -53), Math.toRadians(90))
                        .stopAndAdd(new ArmPivot(-72, armRaise, .3, true))
                        .lineToY(-45)
                        .stopAndAdd(new ServoClose(servoLeft, servoRight, false))
                        .waitSeconds(.5)
                        ...
                        //.turnTo(Math.toRadians(90))
                        .stopAndAdd(new LinearSlide(0, linearSlide, 1, false))
                        .strafeToSplineHeading(new Vector2d(-45, -23), Math.toRadians(180))
                        .stopAndAdd(new ArmPivot(-72, armRaise, .3, true))
                        .lineToX(-55)
                        .stopAndAdd(new ServoClose(servoLeft, servoRight, false))
                        .waitSeconds(.5)
                        ...
                        .strafeTo(new Vector2d(-60, -55))
                        .stopAndAdd(new LinearSlide(0, linearSlide, 1, false))
                        .strafeToSplineHeading(new Vector2d(-50,-50), 0)
                        .build());
    }
